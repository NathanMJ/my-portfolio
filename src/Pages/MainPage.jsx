...
export default function MainPage({langague, setLanguage}) {
        ...
        switch (langague) {
            case 'en':
                return {
                    ...
                    iAm: 'I am',
                    chessDesc: 'An chess analysis application to visually explain the tactical situation.',
                    pentaminoDesc: 'A pentamino solver that finds all possible solutions for a given board size and pentamino set.',
                    shellGameDesc: 'Find the ball, win 5 000 $.',
                    bestAiDesc: 'No comments needed.',
                }
            case 'fr':
                return {
                    ...
                    iAm: 'Je suis',
                    chessDesc: 'Une application d\'analyse d\'échecs pour expliquer visuellement la situation tactique.',
    ...
    const projects = [
        {
            title: 'Chess help',
            desc: traductions.chessDesc
            , img: 'chess-help.png'
        }, {
            title: 'Pentamino solver',
            desc: traductions.pentaminoDesc
            , img: 'pentamino-solver.png'
        }, {
            title: 'Shell game',
            desc: traductions.shellGameDesc
            , img: 'shell-game.png'
        }, {
            title: 'Best AI ever',
            desc: traductions.bestAiDesc
            , img: 'best-ai.png'
        }
    ]
    ...
    function headerFooter(c) {
        return <div className={c}>
            ...
            <div className='middle'>
                <p>{traductions.aboutMe}</p>
                <p>{traductions.portfolio}</p>
                <p>{traductions.contactMe}</p>
            </div>
            <div className='langages'>
                <img src="france.png" alt="france-flag" onClick={() => setLanguage('fr')} />
                <img src="israel.png" alt="israel-flag" onClick={() => setLanguage('he')} />
                <img src="uk.webp" alt="uk-flag" onClick={() => setLanguage('en')} />
            </div>
        </div>
    }
    ...
    return (
        <div className='portfolio-page'>
            ...
            <div className='bottom-portfolio-page'>
                {headerFooter('footer')}
          ...
          ce que vous cherchez, allons un peu plus loin dans le temps.` },
              ...
              en tant que software ingenieur specialisation en fullstack. Diplome avec une moyenne de 97 et une note a ma presentation de projet de fin d'annees de 100 ainsi que des felicitations.` },
               ...
               mes competences en informatique et pouvoir accomplir de grands projets tel que les votres pourquoi pas ?`
                        ...
                        return <div className={`case-container ${even}`} key={index}>
                            ...
                            <div className='border-container side'>
                                <div className='border'>
                                    <div className='up-line'></div>
                                    <div className='bottom-line'></div>
                                </div>
